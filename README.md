...
ShelfPilot Control Room is a WebSharper and F# inventory management system I built for the DUE F# 2026 Alpha project.
It is a basic inventory management webapp
...
The current app uses just demo users and role switching inside the UI rather than a full authentication system. I plan to add that for the final project
...
For the final course project , I plan to  upgrade to real authentication plus persistent storage so user roles and imported catalogs survive restarts.
